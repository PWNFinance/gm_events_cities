...
description: A meeting point for builders, VCs, and web3 enthusiasts to network, learn, and build in the Linea ecosystem.
...
synopsis: 
  - Live on Linea in Istanbul is the first of many IRL stops in the Linea Voyage.
  - This event is the center point of the Linea ecosystem. Join us for panels, workshops, and meetups to explore Ethereum scaling, emerging markets, on-chain identity, decentralized social, and so much more.
...
tickets: https://lu.ma/liveonlinea
